...
function renderView(this: any) {
  ...
  const containerProps = {
    style: [LAYOUT.flexContainer, LAYOUT.flexContainer.verticalCenter, LAYOUT.flexContainer.center, STYLE, style] as any,
    onClick: onClick,
  ...
  return !!window.isInsightsBot && list && list[iconName] ? null : (
    <div {...containerProps}>{list[iconName]({ style, innerStyle, innerClassName })}</div>
  );
}
