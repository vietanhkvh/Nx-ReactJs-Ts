...
export const buttonFacebook = Object.assign({}, buttonBase, {
  backgroundColor: VARIABLE.colorSocial.facebook,
  color: VARIABLE.colorWhite,

  ':hover': {
    backgroundColor: VARIABLE.colorSocial.facebookLighter
  }
});

export const buttonBorder = Object.assign({}, buttonBase, {
  lineHeight: '34px',
